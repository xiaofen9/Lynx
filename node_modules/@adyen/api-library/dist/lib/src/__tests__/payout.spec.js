            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(result.additionalData[apiConstants_1.FRAUD_RESULT_TYPE]).toEqual("GREEN");
                        expect(result.additionalData[apiConstants_1.FRAUD_MANUAL_REVIEW]).toEqual("false");
                        return [2 /*return*/];
                }
            });
        });
