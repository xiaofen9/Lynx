...
export declare namespace Recurring {
    ...
    const ContractEnum: {
        ONECLICK: import("../payout").Recurring.ContractEnum;
        RECURRING: import("../payout").Recurring.ContractEnum;
        PAYOUT: import("../payout").Recurring.ContractEnum;
    };
    type TokenServiceEnum = 'VISATOKENSERVICE' | 'MCTOKENSERVICE';
    const TokenServiceEnum: {
        VISATOKENSERVICE: import("../binLookup").Recurring.TokenServiceEnum;
        MCTOKENSERVICE: import("../binLookup").Recurring.TokenServiceEnum;
    };
}
