...
export declare namespace PaymentRequest {
    ...
    const RecurringProcessingModelEnum: {
        ...
        UnscheduledCardOnFile: RecurringProcessingModelEnum;
    };
    type ShopperInteractionEnum = 'Ecommerce' | 'ContAuth' | 'Moto' | 'POS';
    const ShopperInteractionEnum: {
        Ecommerce: import("../binLookup").CostEstimateRequest.ShopperInteractionEnum;
        ContAuth: import("../binLookup").CostEstimateRequest.ShopperInteractionEnum;
        Moto: import("../binLookup").CostEstimateRequest.ShopperInteractionEnum;
        POS: import("../binLookup").CostEstimateRequest.ShopperInteractionEnum;
    };
}
