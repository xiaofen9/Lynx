...
var NexoCrypto = /** @class */ (function () {
    ...
    NexoCrypto.crypt = function (bytes, dk, ivNonce, mode) {
        var actualIV = Buffer.alloc(nexoConstants_1.NEXO_IV_LENGTH);
        for (var i = 0; i < nexoConstants_1.NEXO_IV_LENGTH; i++) {
    ...
    NexoCrypto.generateRandomIvNonce = function () {
        return crypto_1.randomBytes(nexoConstants_1.NEXO_IV_LENGTH);
    };
