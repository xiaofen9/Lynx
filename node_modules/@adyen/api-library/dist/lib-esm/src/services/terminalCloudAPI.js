...
var TerminalCloudAPI = /** @class */ (function (_super) {
    ...
    TerminalCloudAPI.prototype.async = function (terminalApiRequest) {
        return getJsonResponse(this.terminalApiAsync, Convert.terminalApiRequestToJson(terminalApiRequest));
    };
    TerminalCloudAPI.prototype.sync = function (terminalApiRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getJsonResponse(this.terminalApiSync, Convert.terminalApiRequestToJson(terminalApiRequest))];
                    case 1:
                        response = _a.sent();
