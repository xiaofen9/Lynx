...
var notificationRequestItem = {
    ...
    reason: "reason",
    success: "true",
    additionalData: (_a = {}, _a[HMAC_SIGNATURE] = expectedSign, _a),
};
describe("HMAC Validator", function () {
    ...
    it("should have invalid hmac", function () {
        var _a;
        var invalidNotification = __assign(__assign({}, notificationRequestItem), { additionalData: (_a = {}, _a[HMAC_SIGNATURE] = "notValidSign", _a) });
        var hmacValidator = new HmacValidator();
