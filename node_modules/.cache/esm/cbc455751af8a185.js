"main";let ObjectID;_1af‍.w("mongodb",[["ObjectID",["ObjectID"],function(v){ObjectID=v}]]);let db;_1af‍.w("../../lib/mongo",[["db",["db"],function(v){db=v}]]);let utils;_1af‍.w("../../lib/utils",[["default",["utils"],function(v){utils=v}]]);let parse;_1af‍.w("../../lib/parse",[["default",["parse"],function(v){parse=v}]]);let PaymentMethodsLightService;_1af‍.w("./paymentMethodsLight",[["default",["PaymentMethodsLightService"],function(v){PaymentMethodsLightService=v}]]);let OrdersService;_1af‍.w("./orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);
...
_1af‍.d(new PaymentMethodsService());
