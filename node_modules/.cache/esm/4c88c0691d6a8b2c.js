"main";let ObjectID;_1d6‍.w("mongodb",[["ObjectID",["ObjectID"],function(v){ObjectID=v}]]);let db;_1d6‍.w("../../lib/mongo",[["db",["db"],function(v){db=v}]]);let utils;_1d6‍.w("../../lib/utils",[["default",["utils"],function(v){utils=v}]]);let parse;_1d6‍.w("../../lib/parse",[["default",["parse"],function(v){parse=v}]]);let ShippingMethodsLightService;_1d6‍.w("./shippingMethodsLight",[["default",["ShippingMethodsLightService"],function(v){ShippingMethodsLightService=v}]]);let PaymentMethodsService;_1d6‍.w("./paymentMethods",[["default",["PaymentMethodsService"],function(v){PaymentMethodsService=v}]]);let OrdersService;_1d6‍.w("./orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);
...
_1d6‍.d(new ShippingMethodsService());
