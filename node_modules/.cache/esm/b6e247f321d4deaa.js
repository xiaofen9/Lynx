"main";let combineReducers;_21d‍.w("redux",[["combineReducers",["combineReducers"],function(v){combineReducers=v}]]);let formReducer;_21d‍.w("redux-form",[["reducer",["formReducer"],function(v){formReducer=v}]]);let t;_21d‍.w("./actionTypes",[["*",null,function(v){t=v}]]);
...
_21d‍.d(combineReducers({ app: appReducer, form: formReducer }));