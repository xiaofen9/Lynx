"main";let ObjectID;_49c‍.w("mongodb",[["ObjectID",["ObjectID"],function(v){ObjectID=v}]]);let path;_49c‍.w("path",[["default",["path"],function(v){path=v}]]);let url;_49c‍.w("url",[["default",["url"],function(v){url=v}]]);let formidable;_49c‍.w("formidable",[["default",["formidable"],function(v){formidable=v}]]);let fse;_49c‍.w("fs-extra",[["default",["fse"],function(v){fse=v}]]);let settings;_49c‍.w("../../lib/settings",[["default",["settings"],function(v){settings=v}]]);let db;_49c‍.w("../../lib/mongo",[["db",["db"],function(v){db=v}]]);let utils;_49c‍.w("../../lib/utils",[["default",["utils"],function(v){utils=v}]]);let parse;_49c‍.w("../../lib/parse",[["default",["parse"],function(v){parse=v}]]);let SettingsService;_49c‍.w("../settings/settings",[["default",["SettingsService"],function(v){SettingsService=v}]]);
...
_49c‍.d(new ProductImagesService());
