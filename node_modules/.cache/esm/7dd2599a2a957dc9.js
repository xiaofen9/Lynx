"main";let React;_2a9‍.w("react",[["default",["React"],function(v){React=v}]]);let NavLink;_2a9‍.w("react-router-dom",[["NavLink",["NavLink"],function(v){NavLink=v}]]);let helper;_2a9‍.w("../../lib/helper",[["*",null,function(v){helper=v}]]);let themeSettings,text;_2a9‍.w("../../lib/settings",[["themeSettings",["themeSettings"],function(v){themeSettings=v}],["text",["text"],function(v){text=v}]]);
