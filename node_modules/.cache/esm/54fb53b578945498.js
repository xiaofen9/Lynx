"main";_789‍.x([["default",()=>CustomProducts]]);let React;_789‍.w("react",[["default",["React"],function(v){React=v}]]);let PropTypes;_789‍.w("prop-types",[["default",["PropTypes"],function(v){PropTypes=v}]]);let api;_789‍.w("../../lib/api",[["default",["api"],function(v){api=v}]]);let ProductList;_789‍.w("../productList",[["default",["ProductList"],function(v){ProductList=v}]]);
	...
	constructor(...args) {
		...
		return _temp = super(...args), this.state = {
			...
			api.ajax.products.list(filter).then(({ json }) => {
				if (!this.isCancelled) {
					this.setState({
						products: json.data
					});
