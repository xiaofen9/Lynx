"main";let https;_609‍.w("https",[["default",["https"],function(v){https=v}]]);let qs;_609‍.w("query-string",[["default",["qs"],function(v){qs=v}]]);let OrdersService;_609‍.w("../services/orders/orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);let OrdertTansactionsService;_609‍.w("../services/orders/orderTransactions",[["default",["OrdertTansactionsService"],function(v){OrdertTansactionsService=v}]]);
...
const paymentNotification = options => {
	...
	verify(params, settings)
		.then(() => {
			...
			if (paymentCompleted) {
				_609‍.a("OrdersService",OrdersService).updateOrder(orderId, {
					paid: true,
					date_paid: new Date()
				}).then(() => {
					_609‍.a("OrdertTansactionsService",OrdertTansactionsService).addTransaction(orderId, {
...
const verify = (params, settings) => {
	return new Promise((resolve, reject) => {
		...
		const body = _609‍.a("qs",qs).stringify(params);
		...
		let req = _609‍.a("https",https).request(req_options, res => {
			let data = [];
