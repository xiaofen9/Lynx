"main";let winston;_505‍.w("winston",[["default",["winston"],function(v){winston=v}]]);let nodemailer;_505‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);let smtpTransport;_505‍.w("nodemailer-smtp-transport",[["default",["smtpTransport"],function(v){smtpTransport=v}]]);let settings;_505‍.w("./settings",[["default",["settings"],function(v){settings=v}]]);let EmailSettingsService;_505‍.w("../services/settings/email",[["default",["EmailSettingsService"],function(v){EmailSettingsService=v}]]);
