"main";_5b6‍.x([["pageView",()=>pageView],["viewItem",()=>viewItem],["addToCart",()=>addToCart],["removeFromCart",()=>removeFromCart],["setCheckoutOption",()=>setCheckoutOption],["search",()=>search],["beginCheckout",()=>beginCheckout],["purchase",()=>purchase]]);const event = {
	PAGE_VIEW: 'page_view',
	VIEW_ITEM: 'view_item',
	...
	logEvent({
       ...
       const removeFromCart = ({ itemId, cart }) => {
	...
	logEvent({
       ...
       const setCheckoutOption = ({ step, option, value }) => {
	logEvent({
