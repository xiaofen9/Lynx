...
Collection.prototype.find = deprecateOptions(
  ...
  function(query, options, callback) {
    if (typeof callback === 'object') {
      ...
      _7ab‍.g.console.warn('Third parameter to `find()` must be a callback or undefined');
    }
...
Collection.prototype.findOne = deprecateOptions(
  ...
  function(query, options, callback) {
    if (typeof callback === 'object') {
      // TODO(MAJOR): throw in the future
      _7ab‍.g.console.warn('Third parameter to `findOne()` must be a callback or undefined');
    }
