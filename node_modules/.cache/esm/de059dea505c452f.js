"main";let ObjectID;_505‍.w("mongodb",[["ObjectID",["ObjectID"],function(v){ObjectID=v}]]);let db;_505‍.w("../../lib/mongo",[["db",["db"],function(v){db=v}]]);let utils;_505‍.w("../../lib/utils",[["default",["utils"],function(v){utils=v}]]);let parse;_505‍.w("../../lib/parse",[["default",["parse"],function(v){parse=v}]]);let ShippingMethodsLightService;_505‍.w("./shippingMethodsLight",[["default",["ShippingMethodsLightService"],function(v){ShippingMethodsLightService=v}]]);let PaymentMethodsService;_505‍.w("./paymentMethods",[["default",["PaymentMethodsService"],function(v){PaymentMethodsService=v}]]);let OrdersService;_505‍.w("./orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);
...
_505‍.d(new ShippingMethodsService());
