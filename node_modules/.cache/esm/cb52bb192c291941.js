"main";let combineReducers;_2c2‍.w("redux",[["combineReducers",["combineReducers"],function(v){combineReducers=v}]]);let formReducer;_2c2‍.w("redux-form",[["reducer",["formReducer"],function(v){formReducer=v}]]);let t;_2c2‍.w("./actionTypes",[["*",null,function(v){t=v}]]);
...
_2c2‍.d(combineReducers({ app: appReducer, form: formReducer }));