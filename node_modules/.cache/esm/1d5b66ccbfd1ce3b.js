"main";_bfd‍.x([["Headers",()=>Headers],["Request",()=>Request],["Response",()=>Response],["FetchError",()=>FetchError]]);let Stream,PassThrough;_bfd‍.w("stream",[["default",["Stream"],function(v){Stream=v}],["PassThrough",["PassThrough"],function(v){PassThrough=v}]]);let http,STATUS_CODES;_bfd‍.w("http",[["default",["http"],function(v){http=v}],["STATUS_CODES",["STATUS_CODES"],function(v){STATUS_CODES=v}]]);let format,parse,resolve;_bfd‍.w("url",[["format",["format"],function(v){format=v}],["parse",["parse"],function(v){parse=v}],["resolve",["resolve"],function(v){resolve=v}]]);let https;_bfd‍.w("https",[["default",["https"],function(v){https=v}]]);let zlib;_bfd‍.w("zlib",[["default",["zlib"],function(v){zlib=v}]]);
...
let convert;
try {
	convert = _bfd‍.t("require")('encoding').convert;
} catch (e) {}
