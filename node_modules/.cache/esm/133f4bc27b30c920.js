"main";_7b3‍.x([["Headers",()=>Headers],["Request",()=>Request],["Response",()=>Response],["FetchError",()=>FetchError]]);let Stream,PassThrough;_7b3‍.w("stream",[["default",["Stream"],function(v){Stream=v}],["PassThrough",["PassThrough"],function(v){PassThrough=v}]]);let http,STATUS_CODES;_7b3‍.w("http",[["default",["http"],function(v){http=v}],["STATUS_CODES",["STATUS_CODES"],function(v){STATUS_CODES=v}]]);let format,parse,resolve;_7b3‍.w("url",[["format",["format"],function(v){format=v}],["parse",["parse"],function(v){parse=v}],["resolve",["resolve"],function(v){resolve=v}]]);let https;_7b3‍.w("https",[["default",["https"],function(v){https=v}]]);let zlib;_7b3‍.w("zlib",[["default",["zlib"],function(v){zlib=v}]]);
...
let convert;
try {
	convert = _7b3‍.t("require")('encoding').convert;
} catch (e) {}
