"main";let security;_be4‍.w("../lib/security",[["default",["security"],function(v){security=v}]]);let OrdersService;_be4‍.w("../services/orders/orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);let OrderAddressService;_be4‍.w("../services/orders/orderAddress",[["default",["OrderAddressService"],function(v){OrderAddressService=v}]]);let OrderItemsService;_be4‍.w("../services/orders/orderItems",[["default",["OrderItemsService"],function(v){OrderItemsService=v}]]);let OrdertTansactionsService;_be4‍.w("../services/orders/orderTransactions",[["default",["OrdertTansactionsService"],function(v){OrdertTansactionsService=v}]]);let OrdertDiscountsService;_be4‍.w("../services/orders/orderDiscounts",[["default",["OrdertDiscountsService"],function(v){OrdertDiscountsService=v}]]);let SettingsService;_be4‍.w("../services/settings/settings",[["default",["SettingsService"],function(v){SettingsService=v}]]);let PaymentGateways;_be4‍.w("../paymentGateways",[["default",["PaymentGateways"],function(v){PaymentGateways=v}]]);
