...
class Logger extends stream.Transform {
  ...
  _transform(info, enc, callback) {
    ...
    if (!this.levels[info[LEVEL]] && this.levels[info[LEVEL]] !== 0) {
      ...
      _f65‍.g.console.error('[winston] Unknown logger level: %s', info[LEVEL]);
    }

    // Remark: not sure if we should simply error here.
    if (!this._readableState.pipes) {
      // eslint-disable-next-line no-console
      _f65‍.g.console.error('[winston] Attempt to write logs with no transports %j', info);
    }
  ...
  profile(id, ...args) {
    ...
    if (this.profilers[id]) {
      ...
      if (typeof args[args.length - 2] === 'function') {
        // eslint-disable-next-line no-console
        _f65‍.g.console.warn('Callback function no longer supported as of winston@3.0.0');
        args.pop();
      }
  ...
  handleExceptions(...args) {
    // eslint-disable-next-line no-console
    _f65‍.g.console.warn('Deprecated: .handleExceptions() will be removed in winston@4. Use .exceptions.handle()');
  ...
  unhandleExceptions(...args) {
    // eslint-disable-next-line no-console
    _f65‍.g.console.warn('Deprecated: .unhandleExceptions() will be removed in winston@4. Use .unexceptions.handle()');
