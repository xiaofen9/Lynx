"main";let crypto;_505‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);let OrdersService;_505‍.w("../services/orders/orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);let OrdertTansactionsService;_505‍.w("../services/orders/orderTransactions",[["default",["OrdertTansactionsService"],function(v){OrdertTansactionsService=v}]]);
...
const getHashFromString = str => {
	let sha1 = _505‍.a("crypto",crypto).createHash('sha1');
	sha1.update(str);
