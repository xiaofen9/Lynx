"main";let React;_8d7‍.w("react",[["default",["React"],function(v){React=v}]]);let NavLink;_8d7‍.w("react-router-dom",[["NavLink",["NavLink"],function(v){NavLink=v}]]);let themeSettings,text;_8d7‍.w("../../lib/settings",[["themeSettings",["themeSettings"],function(v){themeSettings=v}],["text",["text"],function(v){text=v}]]);let ItemTags;_8d7‍.w("./itemTags",[["default",["ItemTags"],function(v){ItemTags=v}]]);let ItemImage;_8d7‍.w("./itemImage",[["default",["ItemImage"],function(v){ItemImage=v}]]);let ItemPrice;_8d7‍.w("./itemPrice",[["default",["ItemPrice"],function(v){ItemPrice=v}]]);
