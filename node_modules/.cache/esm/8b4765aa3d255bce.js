"main";let combineReducers;_3d2‍.w("redux",[["combineReducers",["combineReducers"],function(v){combineReducers=v}]]);let formReducer;_3d2‍.w("redux-form",[["reducer",["formReducer"],function(v){formReducer=v}]]);let t;_3d2‍.w("./actionTypes",[["*",null,function(v){t=v}]]);
...
_3d2‍.d(combineReducers({ app: appReducer, form: formReducer }));