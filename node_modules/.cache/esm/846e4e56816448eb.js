"main";let ObjectID;_816‍.w("mongodb",[["ObjectID",["ObjectID"],function(v){ObjectID=v}]]);let url;_816‍.w("url",[["default",["url"],function(v){url=v}]]);let jwt;_816‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);let moment;_816‍.w("moment",[["default",["moment"],function(v){moment=v}]]);let uaParser;_816‍.w("ua-parser-js",[["default",["uaParser"],function(v){uaParser=v}]]);let handlebars;_816‍.w("handlebars",[["default",["handlebars"],function(v){handlebars=v}]]);let lruCache;_816‍.w("lru-cache",[["default",["lruCache"],function(v){lruCache=v}]]);let db;_816‍.w("../../lib/mongo",[["db",["db"],function(v){db=v}]]);let parse;_816‍.w("../../lib/parse",[["default",["parse"],function(v){parse=v}]]);let settings;_816‍.w("../../lib/settings",[["default",["settings"],function(v){settings=v}]]);let mailer;_816‍.w("../../lib/mailer",[["default",["mailer"],function(v){mailer=v}]]);let SettingsService;_816‍.w("../settings/settings",[["default",["SettingsService"],function(v){SettingsService=v}]]);
...
_816‍.d(new SecurityTokensService());
