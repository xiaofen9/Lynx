"main";let crypto;_5a6‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);let OrdersService;_5a6‍.w("../services/orders/orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);let OrdertTansactionsService;_5a6‍.w("../services/orders/orderTransactions",[["default",["OrdertTansactionsService"],function(v){OrdertTansactionsService=v}]]);
...
const paymentNotification = options => {
	...
	if (signatureValid && paymentSuccess) {
		_5a6‍.a("OrdersService",OrdersService).updateOrder(orderId, {
			paid: true,
			date_paid: new Date()
		}).then(() => {
			_5a6‍.a("OrdertTansactionsService",OrdertTansactionsService).addTransaction(orderId, {
...
const getHashFromString = str => {
	let sha1 = _5a6‍.a("crypto",crypto).createHash('sha1');
	sha1.update(str);
