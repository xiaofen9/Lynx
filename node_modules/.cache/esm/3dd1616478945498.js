"main";let React;_789‍.w("react",[["default",["React"],function(v){React=v}]]);let Field,reduxForm;_789‍.w("redux-form",[["Field",["Field"],function(v){Field=v}],["reduxForm",["reduxForm"],function(v){reduxForm=v}]]);let themeSettings,text;_789‍.w("../../lib/settings",[["themeSettings",["themeSettings"],function(v){themeSettings=v}],["text",["text"],function(v){text=v}]]);let formatCurrency;_789‍.w("../../lib/helper",[["formatCurrency",["formatCurrency"],function(v){formatCurrency=v}]]);let InputField;_789‍.w("./inputField",[["default",["InputField"],function(v){InputField=v}]]);
