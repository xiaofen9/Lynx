"main";let https;_505‍.w("https",[["default",["https"],function(v){https=v}]]);let qs;_505‍.w("query-string",[["default",["qs"],function(v){qs=v}]]);let OrdersService;_505‍.w("../services/orders/orders",[["default",["OrdersService"],function(v){OrdersService=v}]]);let OrdertTansactionsService;_505‍.w("../services/orders/orderTransactions",[["default",["OrdertTansactionsService"],function(v){OrdertTansactionsService=v}]]);
...
const paymentNotification = options => {
	...
	verify(params, settings)
		.then(() => {
			...
			if (paymentCompleted) {
				_505‍.a("OrdersService",OrdersService).updateOrder(orderId, {
					paid: true,
					date_paid: new Date()
				}).then(() => {
					_505‍.a("OrdertTansactionsService",OrdertTansactionsService).addTransaction(orderId, {
...
const verify = (params, settings) => {
	return new Promise((resolve, reject) => {
		...
		const body = _505‍.a("qs",qs).stringify(params);
		...
		let req = _505‍.a("https",https).request(req_options, res => {
			let data = [];
