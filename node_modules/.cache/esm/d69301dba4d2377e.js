"main";let React;_a4d‍.w("react",[["default",["React"],function(v){React=v}]]);let PropTypes;_a4d‍.w("prop-types",[["default",["PropTypes"],function(v){PropTypes=v}]]);let NavLink;_a4d‍.w("react-router-dom",[["NavLink",["NavLink"],function(v){NavLink=v}]]);let text;_a4d‍.w("../lib/settings",[["text",["text"],function(v){text=v}]]);let helper;_a4d‍.w("../lib/helper",[["*",null,function(v){helper=v}]]);
