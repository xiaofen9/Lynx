"main";let React;_2a9‍.w("react",[["default",["React"],function(v){React=v}]]);let PropTypes;_2a9‍.w("prop-types",[["default",["PropTypes"],function(v){PropTypes=v}]]);let NavLink;_2a9‍.w("react-router-dom",[["NavLink",["NavLink"],function(v){NavLink=v}]]);let text;_2a9‍.w("../lib/settings",[["text",["text"],function(v){text=v}]]);let helper;_2a9‍.w("../lib/helper",[["*",null,function(v){helper=v}]]);
